...
const Profile = () => {
  ...
  const handlePostSubmit = async (e) => {
    ...
    try {
      ...
      if (error.response) {
        toast.error(
          `Erro ao criar o post: ${error.response.data.message || error.response.data.error
          }`
        );
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      ...
      if (error.response) {
        toast.error(
          `Erro ao atualizar o perfil: ${error.response.data.message || error.response.data.error
          }`
        );
      } else if (error.request) {
        toast.error("Nenhuma resposta do servidor.");
  ...
  const handleEditPostSubmit = async (e) => {
    ...
    try {
      ...
      if (error.response) {
        toast.error(
          `Erro ao atualizar o post: ${error.response.data.message || error.response.data.error
          }`
        );
      } else if (error.request) {
        toast.error("Nenhuma resposta do servidor.");
  ...
  const handleDeletePost = async (postId) => {
    try {
      ...
      if (error.response) {
        toast.error(
          `Erro ao deletar o post: ${error.response.data.message || error.response.data.error
          }`
        );
      } else if (error.request) {
        toast.error("Nenhuma resposta do servidor.");
          ...
          <div key={post._id} className="post-card">
            <div className="post-header">
              ...
              <div className="post-menu">
                <button className="options__icon" onClick={() => toggleMenu(post._id)}>
                  <span></span>
                  <span></span>
                  <span></span>
                </button>
